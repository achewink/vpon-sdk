...
!function(a) {
    ...
    // nva-right choose language
    lang = $('html').attr('lang');
    userLang = lang.toLowerCase();
    url = window.location.href;
      if(userLang=='en'){
        $('.en').attr('onclick', "this.href = url.replace('vpon-sdk', 'vpon-sdk')");
        $('.zh-tw').attr('onclick',"this.href = url.replace('vpon-sdk/','vpon-sdk/zh-tw/')");
        $('.zh-cn').attr('onclick', "this.href = url.replace('vpon-sdk/','vpon-sdk/zh-cn/')");
        $('.jp').attr('onclick', "this.href = url.replace('vpon-sdk/','vpon-sdk/jp/')");
      }else if(userLang=="zh-tw"){
        $('.zh-tw').attr('onclick', "this.href = url.replace('vpon-sdk/zh-tw','vpon-sdk/zh-tw')");
        $('.en').attr('onclick', "this.href = url.replace('vpon-sdk/zh-tw','vpon-sdk')");
        $('.zh-cn').attr('onclick', "this.href = url.replace('vpon-sdk/zh-tw','vpon-sdk/zh-cn')");
        $('.jp').attr('onclick', "this.href = url.replace('vpon-sdk/zh-tw','vpon-sdk/jp')");
        // $('.right-android').attr('href', "this.href.replace('vpon-sdk/','vpon-sdk/zh-tw')");
        $('.right-android').attr('href', '/vpon-sdk/zh-tw/android/');
        $('.right-ios').attr('href', '/vpon-sdk/zh-tw/ios/');
        $('.right-web').attr('href', '/vpon-sdk/zh-tw/web/');

      }else if(userLang=='zh-cn'){
        $('.zh-cn').attr('onclick', "this.href = url.replace('vpon-sdk/zh-cn','vpon-sdk/zh-cn')");
        $('.en').attr('onclick', "this.href = url.replace('vpon-sdk/zh-cn','vpon-sdk')");
        $('.zh-tw').attr('onclick', "this.href = url.replace('vpon-sdk/zh-cn','vpon-sdk/zh-tw')");
        $('.jp').attr('onclick', "this.href = url.replace('vpon-sdk/zh-cn','vpon-sdk/jp')");
        $('.right-android').attr('href', '/vpon-sdk/zh-cn/android/');
        $('.right-ios').attr('href', '/vpon-sdk/zh-cn/ios/');
        $('.right-web').attr('href', '/vpon-sdk/zh-cn/web/');
      }else{
        $('.jp').attr('onclick', "this.href = url.replace('vpon-sdk/jp/','vpon-sdk/jp/')");
        $('.en').attr('onclick', "this.href = url.replace('vpon-sdk/jp/','vpon-sdk/')");
        $('.zh-tw').attr('onclick', "this.href = url.replace('vpon-sdk/jp','vpon-sdk/zh-tw')");
        $('.zh-cn').attr('onclick', "this.href = url.replace('vpon-sdk/jp','vpon-sdk/zh-cn')");
        $('.right-android').attr('href', '/vpon-sdk/jp/android/');
        $('.right-ios').attr('href', '/vpon-sdk/jp/ios/');
        $('.right-web').attr('href', '/vpon-sdk/jp/web/');
      }
}(jQuery);
